...
router.get("/myprofile/email/:email", protectRecruiter, protectAdmin, fetchRecruiterByEmail);
...
router.delete("/myprofile/delete", protectRecruiter, protectAdmin, deleteRecruiter);
